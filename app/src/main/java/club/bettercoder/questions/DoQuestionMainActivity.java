...
public class DoQuestionMainActivity extends BaseActivity {
    ...
    protected void initView() {
        ...
        questionItemA = (TextView) findViewById(R.id.question_item_A);
        questionItemB = (TextView) findViewById(R.id.question_item_B);
        questionItemC = (TextView) findViewById(R.id.question_item_C);
        questionItemD = (TextView) findViewById(R.id.question_item_D);
        questionAnswer = (TextView) findViewById(R.id.question_answer);
        questionAnalyse = (TextView) findViewById(R.id.question_analyse);
    }
